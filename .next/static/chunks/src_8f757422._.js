...
function SkillProvider({ children }) {
    ...
    const migrateLocalToFirestore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SkillProvider.useCallback[migrateLocalToFirestore]": async (userId)=>{
            try {
                const localSkillsRaw = localStorage.getItem(SKILLS_STORAGE_KEY);
                if (localSkillsRaw) {
                    const localSkills = JSON.parse(localSkillsRaw);
                    const userSkillsRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(firestore, `users/${userId}/skills`, 'user_skills');
                    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setDoc"])(userSkillsRef, localSkills, {
                        merge: true
                    });
    ...
    }["SkillProvider.useCallback[migrateLocalToFirestore]"], [
        firestore
    ]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SkillProvider.useEffect": ()=>{
            const loadSkills = {
                "SkillProvider.useEffect.loadSkills": async ()=>{
                    setIsInitialized(false);
                    try {
                        if (user) {
                            const userSkillsRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(firestore, `users/${user.uid}/skills`, 'user_skills');
                            const docSnap = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDoc"])(userSkillsRef);
                            if (docSnap.exists()) {
                                ...
                                const newDocSnap = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDoc"])(userSkillsRef);
            ...
            }["SkillProvider.useEffect.loadSkills"];
            loadSkills();
        }
    }["SkillProvider.useEffect"], [
        user,
    ...
    const toggleSkill = (skill)=>{
        ...
        if (user) {
            const userSkillsRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(firestore, `users/${user.uid}/skills`, 'user_skills');
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$non$2d$blocking$2d$updates$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setDocumentNonBlocking"])(userSkillsRef, updatedSkills, {
                merge: true
            });
        }
    };
...
_s(SkillProvider, "bRTnSbuAzH/t9KEsogn2KuMPvdg=", false, function() {
    return [
...
//# sourceMappingURL=src_8f757422._.js.map