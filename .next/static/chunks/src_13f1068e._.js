...
function SkillProvider({ children }) {
    ...
    const toggleSkill = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SkillProvider.useCallback[toggleSkill]": (skillId)=>{
            dispatch({
                type: 'TOGGLE_SKILL',
                payload: skillId
            });
        }
    }["SkillProvider.useCallback[toggleSkill]"], []);
    const importSkills = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SkillProvider.useCallback[importSkills]": (skillIds)=>{
            dispatch({
                type: 'IMPORT_SKILLS',
                payload: skillIds
            });
        }
    }["SkillProvider.useCallback[importSkills]"], []);
...
_s(SkillProvider, "dOqKDUh/HgcOTIo4+3WwFC18yZk=");
_c = SkillProvider;
const useSkills = ()=>{
    _s1();
...
//# sourceMappingURL=src_13f1068e._.js.map