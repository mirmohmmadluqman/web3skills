...
"[project]/src/ai/flows/data:0fb134 [app-ssr] (ecmascript) <text/javascript>": ((__turbopack_context__) => {
"use strict";
...
const firebaseConfig = {
    "projectId": "studio-3220017078-17a57",
    "appId": "1:333842611351:web:880ad04bd3ca3500937dd2",
    "apiKey": "AIzaSyDk3QsX80yDsipe8SGfHMbUn6LHk66F09U",
    "authDomain": "studio-3220017078-17a57.firebaseapp.com",
    "measurementId": "",
    "messagingSenderId": "333842611351"
};
}}),
...
"[project]/src/hooks/use-skills.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$ai$2f$flows$2f$data$3a$0fb134__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/ai/flows/data:0fb134 [app-ssr] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$module__evaluation$3e$__ = __turbopack_context__.i("[project]/src/firebase/index.ts [app-ssr] (ecmascript) <module evaluation>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$provider$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/firebase/provider.tsx [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2f$firestore$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$module__evaluation$3e$__ = __turbopack_context__.i("[project]/node_modules/firebase/firestore/dist/index.mjs [app-ssr] (ecmascript) <module evaluation>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@firebase/firestore/dist/index.node.mjs [app-ssr] (ecmascript)");
...
;
;
const SkillContext = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createContext"])(undefined);
const SKILLS_STORAGE_KEY = 'web3skills';
const initialSkills = Object.keys(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$skills$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ALL_SKILLS"]).reduce((acc, skill)=>{
    acc[skill] = false;
    return acc;
}, {});
function SkillProvider({ children }) {
    ...
    const migrateLocalToFirestore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (userId)=>{
        try {
            const localSkillsRaw = localStorage.getItem(SKILLS_STORAGE_KEY);
            if (localSkillsRaw) {
                const localSkills = JSON.parse(localSkillsRaw);
                const userSkillsRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["doc"])(firestore, `users/${userId}/skills`, 'user_skills');
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["setDoc"])(userSkillsRef, localSkills, {
                    merge: true
                });
            ...
            console.error("Failed to migrate skills from localStorage to Firestore", error);
        }
    }, [
        firestore
    ]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const loadSkills = async ()=>{
            ...
            try {
                if (user) {
                    const userSkillsRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["doc"])(firestore, `users/${user.uid}/skills`, 'user_skills');
                    const docSnap = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getDoc"])(userSkillsRef);
                    if (docSnap.exists()) {
                        const firestoreSkills = docSnap.data();
                        const validSkills = {};
                        for (const skillName of Object.keys(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$skills$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ALL_SKILLS"])){
                            validSkills[skillName] = !!firestoreSkills[skillName];
                        }
                        setSkills(validSkills);
                    } else {
                        await migrateLocalToFirestore(user.uid);
                        // if still no skills, initialize with empty
                        const newDocSnap = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getDoc"])(userSkillsRef);
    ...
    const checkForMastery = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((updatedSkills, originalSkills)=>{
        Object.entries(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$skills$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["SKILL_CATEGORIES"]).forEach(async ([categoryName, categorySkills])=>{
            const wasComplete = categorySkills.every((skill)=>originalSkills[skill]);
            const isNowComplete = categorySkills.every((skill)=>updatedSkills[skill]);
            if (isNowComplete && !wasComplete) {
                try {
                    const { message } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$ai$2f$flows$2f$data$3a$0fb134__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getCategoryMasteryMessage"])({
                        categoryName
                    });
                    toast({
    ...
    const toggleSkill = (skill)=>{
        ...
        if (user) {
            const userSkillsRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["doc"])(firestore, `users/${user.uid}/skills`, 'user_skills');
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$non$2d$blocking$2d$updates$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["setDocumentNonBlocking"])(userSkillsRef, updatedSkills, {
                merge: true
            });
        }
    };
    const exportSkillsAsMarkdown = ()=>{
        ...
        Object.entries(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$skills$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["SKILL_CATEGORIES"]).forEach(([categoryName, categorySkills])=>{
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(SkillContext.Provider, {
        value: value,
        children: children
    }, void 0, false, {
...
const useSkills = ()=>{
    const context = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useContext"])(SkillContext);
    if (context === undefined) {
...
function Providers({ children }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$skills$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["SkillProvider"], {
        children: children
    }, void 0, false, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1438653d._.js.map