...
const reducer = (state, action)=>{
    switch(action.type){
        ...
        case 'TOGGLE_SKILL':
            const newSkills = new Set(state.selectedSkills);
            if (newSkills.has(action.payload)) {
                newSkills.delete(action.payload);
            } else {
                newSkills.add(action.payload);
            }
            return {
                ...state,
...
function SkillProvider({ children }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        try {
            ...
            const payload = stored ? new Set(JSON.parse(stored)) : new Set();
            dispatch({
                type: 'INITIALIZE',
                payload
            });
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (state.isInitialized) {
            try {
                localStorage.setItem(SKILLS_STORAGE_KEY, JSON.stringify(Array.from(state.selectedSkills)));
            } catch (error) {
    ...
    const toggleSkill = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((skillId)=>{
        dispatch({
            type: 'TOGGLE_SKILL',
            payload: skillId
        });
    }, []);
    const importSkills = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((skillIds)=>{
        dispatch({
            type: 'IMPORT_SKILLS',
            payload: skillIds
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e491110e._.js.map